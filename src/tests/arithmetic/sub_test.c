...
START_TEST(s21_test1) {
  ...
  int ret = s21_sub(firstDc, secondDc, &resultDc);
...
START_TEST(s21_test18) {
  ...
  ck_assert_int_eq(88, resultDc.bits[0]);
}
END_TEST
...
START_TEST(s21_test19) {
  ...
  ck_assert_int_eq(0, get_sign(resultDc));
  ck_assert_int_eq(1, get_scale(resultDc));
  ck_assert_int_eq(105, resultDc.bits[0]);
}
END_TEST
...
START_TEST(s21_test36) {
  ...
  ck_assert_int_eq(1, get_sign(resultDc));
  ck_assert_int_eq(1, get_scale(resultDc));
  ck_assert_int_eq(3, resultDc.bits[0]);
}
END_TEST
...
START_TEST(s21_test37) {
  ...
  ck_assert_int_eq(105390, resultDc.bits[0]);
}
END_TEST
...
START_TEST(s21_test38) {
  ...
  ck_assert_int_eq(0, get_sign(resultDc));
  ck_assert_int_eq(4, get_scale(resultDc));
  ck_assert_int_eq(120389985, resultDc.bits[0]);
}
END_TEST
...
START_TEST(s21_test43) {
  s21_decimal firstDc = {{4147483647, 4147483647, 4147483647, 0}};
  s21_decimal secondDc = {{2345342434, 4147483647, 4147483647, 0}};
  s21_decimal resultDc = {0};
...
Suite *s21_sub_suite(void) {
  ...
  s = suite_create("\033[32m sub \033[0m");
  s21_testing = tcase_create("\033[31m sub \033[0m");
  ...
  tcase_add_test(s21_testing, s21_test43);
